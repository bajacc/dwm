...
static Key keys[] = {
	...
	{ MODKEY,                       XK_c,      spawn,          SHCMD("xclip -selection primary -o | xclip -selection clipboard") },
	...
	TAGKEYS(                        XK_8,                      7)
	TAGKEYS(                        XK_9,                      8)
	{ MODKEY,			            XK_r,      spawn,          SHCMD("winman reload") }, // reload dwm
	{ MODKEY|ShiftMask,             XK_q,      spawn,          SHCMD("winman quit") }, // quit dwm
